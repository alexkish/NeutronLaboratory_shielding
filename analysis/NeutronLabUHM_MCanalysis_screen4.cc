...
void NeutronLabUHM_MCanalysis_screen4()
{	
	gStyle	->SetOptStat(0);
	gStyle	->SetOptFit(0);
	//gStyle	->SetOptFit(1);
	...
	const char *FileName 	= "neutronISO-DT_confine-EmissionPoint_1e6_screen4_tunnel-BPE5_dump-BPE5";
	//const char *FileName 	= "neutronISO-DT_confine-EmissionPoint_1e6_screen4_tunnel-BPE5-10cm_dump-BPE5_NeutronGamma";
	//const char *FileName 	= "neutronISO-DT_confine-EmissionPoint_1e6_screen4_tunnel-BPE5-20cm_dump-BPE5_NeutronGamma";
	//const char *FileName 	= "neutronISO-DT_confine-EmissionPoint_1e6_screen4_tunnel-BPE5_dump-BPE30";
	//const char *FileName 	= "neutronISO-DT_confine-EmissionPoint_1e6_screen4_tunnel-BPE5_dump-BPE5_LiLayer-5mm_NeutronGamma";
	//const char *FileName 	= "neutronISO-DT_confine-EmissionPoint_1e6_screen4_tunnel-BPE5_dump-BPE5_LiLayer-10mm_NeutronGamma";
	//const char *FileName 	= "DD_1e6_screen4_tunnel-BPE5-1cm_dump-BPE5-1cm";
	//const char *FileName 	= "DD_1e6_screen4_tunnel-BPE5-1mm_dump-BPE5-1mm";
...
*/	
	...
	TCut cut_window 	= "xp>-720 && xp<-620 && zp>-310 && zp<-210";
	...
	double Nevts_peak 	= h1_1->Integral(13800/binwidth_Eneutron, 15000/binwidth_Eneutron); 
	double Nevts_bg 	= h1_1->Integral(0/binwidth_Eneutron, 13800/binwidth_Eneutron);
	cout <<"N events in the peak = "<< Nevts_peak << endl;
	cout <<"N events below the peak (BG) = "<< Nevts_bg << endl;

 	//h1_1->GetXaxis()->SetRange(13800/binwidth_Eneutron, 15000/binwidth_Eneutron);
